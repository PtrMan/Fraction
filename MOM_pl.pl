...
iss(switch18x15,notactive,T0+1,Path):- iss(rock18x13,notopen,T0,P),append([rock18x13,is,notopen],P,Path).
iss(rock18x13,notopen,T0+1,Path):- iss(switch18x15,notactive,T0,P),append([switch18x15,is,notactive],P,Path).
